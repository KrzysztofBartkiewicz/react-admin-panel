export const getAnchor = (state) => state.anchor;
export const getOrders = (state) => state.orders;
export const getCurrentOrderId = (state) => state.currentOrderId;
export const isModalOpen = (state) => state.isModalOpen;
export const isDialogOpen = (state) => state.isDialogOpen;
export const isOrderEdited = (state) => state.isOrderEdited;
